...
public class NotesEditorActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		long id = getIntent().getExtras().getLong("note_id");
		String tc = nh.getTextContentById(id);

		textContent = (TextView) findViewById(R.id.noteseditor_note_text_view);
		name = (TextView) findViewById(R.id.noteseditor_name);
		editButton = (Button) findViewById(R.id.noteseditor_edit_button);
